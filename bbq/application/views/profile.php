...
<head>
	...
	<title>企业概况-烤天下酒吧烧烤加盟官网 酒吧文化烧烤领导者 </title>
...
<section id="" class="Talents profile">
	<div class="container profile-color">
		...
		<div class="profile-img">
			<img src="<?php echo base_url('static/img/icon/profile.jpg') ?>" alt="">
		</div>
			...
			<div id="timeline">
				<div class="timeline-item">
					<div class="timeline-icon">
						<img src="<?php echo base_url('static/img/icon/icon-time.png') ?>" alt="">
						<span>2009</span>
					</div>
				...
				<div class="timeline-item">
					<div class="timeline-icon timeline-icon-s">
						<img src="<?php echo base_url('static/img/icon/icon-time-s.p') ?>ng" alt="">
					</div>
...
<script>
 $('.pc-nav-ente').children('a').addClass("ente-current");
