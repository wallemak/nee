...
<div class="btn-toolbar">
    <button class="btn btn-primary" onClick="location='<?php echo site_url('admin/show/show_add'); ?>'"><i class="icon-plus"></i>添加展示</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td><?php echo $a++;?></td>
          <td><?php echo $value['show_title']?></td>
          <td><?php echo str_cut($value['show_con'],0,25); ?></td>
          <td>
              <a href="<?php echo site_url("admin/show/show_edit");?>?show_id=<?php echo $value['show_id']; ?>"><i class="icon-pencil"></i></a>
              <a href="#myModal" role="button" data-toggle="modal" data_id="<?php echo $value['show_id'];?>" id="a_delete" ><i class="icon-remove"></i></a>
          </td>
        </tr>
