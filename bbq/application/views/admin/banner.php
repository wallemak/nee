    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><img src="<?php echo base_url($value['banner_photo'])?>" alt="" style="height:50px;" /></td>
          <td><?php echo $value['banner_addtime']?></td>
          <td><?php echo $value['banner_ord']?></td>
          <td>
              <a href="<?php echo site_url("admin/banner/banner_edit");?>?banner_id=<?php echo $value['banner_id']; ?>"><i class="icon-pencil"></i></a>
              <a href="#myModal" role="button" data-toggle="modal" data_id="<?php echo $value['banner_id'];?>" id="a_delete" ><i class="icon-remove"></i></a>
          </td>
        </tr>
