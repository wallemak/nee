...
<div class="btn-toolbar">
    <button class="btn btn-primary" onClick="location='<?php echo site_url('admin/news/new_add'); ?>'"><i class="icon-plus"></i>添加新闻</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><img src="<?php echo base_url($value['new_photo'])?>" alt="" style="height:50px;" /></td>
          <td><?php echo str_cut($value['new_con'],0,20) ?></td>
          <td><?php echo $value['new_addtime']?></td>
          <td><?php echo $value['new_ord']?></td>
          <td>
              <a href="<?php echo site_url("admin/news/new_edit");?>?new_id=<?php echo $value['new_id']; ?>"><i class="icon-pencil"></i></a>
              <a href="#myModal" role="button" data-toggle="modal" data_id="<?php echo $value['new_id'];?>" id="a_delete" ><i class="icon-remove"></i></a>
          </td>
        </tr>
