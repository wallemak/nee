...
<!-- activity -->
<!-- News-page top -->
<section id="news-detail-intro" style="padding-top:80px;"></section>
<div id="topic">
	<div class="container">
		<div class="row">
			<div class="col-6">
			...
			<div class="col-6">
				<a class="right" href="news.html">返回</a>
			</div>
		</div>
	</div>
</div>
...
<section id="news-detail">
	<div class="container">
		<article>
			<h2 class="heading">我们的初心，就是让创业者们成功</h2>
			<span class="date">2017年05月05日</span>
			<div class="detail">
				<p>
					在风起云涌的餐饮江湖，烤天下异军突起，不仅凭借强势的酒吧烧烤文化刷新了烧烤行业的标准，而且独有的“空投式创业系统”也让烤天下的加盟代理商们在新式餐饮时代里掘到了一桶金。在这个万众创业的时代，烤天下是如何在餐饮红海里让创业者们占据高地的呢？带着这个问题，我们的记者对烤天下的创始人熊校军进行了专访。
				</p>
				<figure>
